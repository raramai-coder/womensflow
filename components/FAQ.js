...
export default function FAQ({ navigation }) {
  ...
  var textAnswer =
    "Yes you can, it is possible for you to get pregnant if you have unprotected sex during your period";
  return (
      ...
      <ScrollView style={styles.scrollView}>
        ...
        >
          <View style={styles.container}>
            <Text style={styles.textAnswer}>{textAnswer}</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Alert.alert(
              "First up, why the heck do we call it a “menstrual” cycle anyway? Turns out, it comes from the Latin word menses, which translates to month. Ah, so it actually does make sense."
            )
          }
        >
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Alert.alert(
              "If your cramps are not alleviated with traditional over the counter medications, you may have another condition such as endometriosis or adenomyosis – disorders with the uterus and menstrual tissue.” So, if popping a pain reliever doesn’t help, get yourself to the gyno to see"
            )
          }
        >
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Alert.alert(
              "Menstrual cups are usually made of silicone and rarely cause any type of allergic reaction. They’re generally safe to use.” Just be sure to follow the instructions carefully, and empty it as often as recommended, for best results "
            )
          }
        >
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Alert.alert(
              "Have fun! But do make sure you do not skip your normal method of protection. Basically, ensure you have good contraception and STI (sexually transmitted infection) prevention throughout the menstrual cycle should make it even more safe and enjoyable."
            )
          }
        >
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() =>
            Alert.alert("It is really a matter of personal preference")
          }
        >
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Alert.alert(
              "Sometimes when you have heavy flow, your body doesn’t have time to break down thick menstrual blood, resulting in clots. It’s nothing to worry about, unless the clots are bigger than the size of a quarter"
            )
          }
        >
          <Text>
            Should I be worried if I see clots coming out during my period?
          </Text>
        </TouchableOpacity>
        <Text></Text>
        <TouchableOpacity
          ...
          onPress={() =>
            Alert.alert(
              "This is usually due to a shift in your hormones, primarily progesterone, which may cause mood swings, GI upset, and even flu-like symptoms of fatigue"
            )
          }
        >
          <Text>
            Why do I feel like I’m coming down with the flu right before I start
            my period?
          </Text>
        </TouchableOpacity>
        <Text></Text>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Alert.alert(
              "Egg freezing technology has had some significant advancements over the last several years, but it’s still not the right solution for all women and all situations. Generally speaking, women in their 20s or early 30s will have greater success with egg freezing.Reproductive specialists have varying degrees of success with pregnancy after egg freezing.There’s no guarantee that freezing your eggs now will guarantee a baby later on"
            )
          }
        >
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Alert.alert(
              "It is always better to be well informed about any possible side-effects which can occur as a result of medications or other forms of fertility treatment. This helps you to be mentally prepared for the same."
            )
          }
        >
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Alert.alert(
              "Success rates for any kind of fertility treatment are influenced by the individual patient’s response to the treatment. Your doctor may tell you his experience of a successful pregnancy with patients of similar profile to that of yours."
            )
          }
        >
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Alert.alert(
              "If one of the treatment options fails, your doctor may advise you to go for other options. For example, if you have had an unsuccessful IUI, your doctor may advise you to go for IVF or ICSI or IVF surrogacy depending upon feasibility."
            )
          }
        >
          <Text>
            What Other Treatment Can We Plan If This One Turns Out Unsuccessful?
          </Text>
        </TouchableOpacity>
        <Text></Text>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            Alert.alert(
              "It ultimately depends on your sexual behaviors. It is recommended that any sexually active female under the age of 25 receive at least annual screenings"
            )
          }
        >
        ...
        >
          <Text>
            If I receive treatment for an STD does that mean I can’t catch it
            again in the future?{" "}
          </Text>
        </TouchableOpacity>
        <Text></Text>
        ...
        >
          <Text>
            My vaginal discharge is a different color than normal, does that
            mean I have an STD?{" "}
          </Text>
        </TouchableOpacity>
        <Text></Text>
